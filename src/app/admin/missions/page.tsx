...
const STATE_LABELS: Record<string, string> = { ACTIVE: "Active", CLOSED: "Fermée", DONE: "Terminée" };
...
export default function AdminMissionsPage() {
    ...
    const fetchMissions = () =>
        fetch("/api/admin/missions")
            .then((r) => r.json())
            .then((data) => { setMissions(data); setFiltered(data); })
                                ...
                                <tr key={mission.id} className="hover:bg-gray-50">
                                    <td className="px-4 py-3">
                                        <div>
                                            ...
                                            <p className="text-gray-500 text-xs">{mission.points} pts</p>
                                        </div>
                                    </td>
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            Toutes les inscriptions et réalisations associées seront supprimées.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        <Button variant="outline" onClick={() => setDeleteTarget(null)}>Annuler</Button>
                        <Button variant="destructive" onClick={() => deleteTarget && deleteMission(deleteTarget.id)}>
                            Supprimer
                        </Button>
                    </DialogFooter>
                </DialogContent>
